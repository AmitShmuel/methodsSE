...
void main() {
	...
	UIComponent* panel = new Panel(0, 0, CCTRL.getConsoleSize().X - 10, CCTRL.getConsoleSize().Y - 10, Double, White, Black, NULL);
	...
	RadioBox* radioBox = new RadioBox(radioOptions,3,40, 15, 15);
